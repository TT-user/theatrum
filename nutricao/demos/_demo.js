/* ============================================================
   Camada de demonstração — Theatrum · nutrição
   Carregada em todos os sites de exemplo em /nutricao/demos/.
   Faz duas coisas:
...
(function () {
  ...
  /* ---------- de onde a pessoa veio ----------
     Estes demos moravam em /moveis-planejados/demos/, herdados de
     quando a esteira de nutrição nasceu dentro da de planejados. A URL
     não se explicava para ninguém e o "voltar" caía numa landing de
     móveis, que é outro assunto. Agora eles têm área própria.

     Por isso aqui não existe o ramo "planejados": nutrição não tem
     landing de segmento. Quem chega sem sinal de origem volta para a
     raiz, que é de onde esses demos são abertos.

     O parâmetro ?de= é o sinal confiável, posto nos links da vitrine.
